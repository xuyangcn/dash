...
Only requiring some minor changes is opalcoin.cpp.
...
Changes to opalcoin.cpp
----------------------
opalcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
