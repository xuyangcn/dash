...
Opalcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month. 
...
mnbudget prepare proposal-name url payment_count block_start opalcoin_address monthly_payment_opalcoin [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ OPALCOIN, _12_ times over the course of a year totaling _24000_ OPALCOIN. 
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` OPALCOIN. 

The following new RPC commands are supported:
- mnbudget "command"... ( "passphrase" )
 - prepare            - Prepare proposal for network by signing and creating tx
 - submit             - Submit proposal for network
 - vote-many          - Vote on a Opalcoin initiative
 - vote-alias         - Vote on a Opalcoin initiative
 - vote               - Vote on a Opalcoin initiative/budget
