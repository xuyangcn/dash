...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Opalcoin features */
    { "opalcoin",               "masternode",             &masternode,             true,      true,       false },
    { "opalcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "opalcoin",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "opalcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "opalcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
...
#ifdef ENABLE_WALLET
    { "opalcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use opalcoind, or the -server option to opalcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
