...
/* *** BEGIN DARKSEND MAGIC - OPALCOIN **********
    Copyright (c) 2014-2015, Opalcoin Developers
        eduffield - evan@opalcoinpay.io
        udjinm6   - udjinm6@opalcoinpay.io
*/
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("opalcoin-darksend");
