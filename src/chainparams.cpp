...
// Copyright (c) 2014-2015 The Opalcoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	( 3311, uint256("0x00000225eba5d2f4b83c334c0ceb069f1de459e828267bbed32edf07c21a5568"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1464498277, // * UNIX timestamp of last checkpoint block
        3315,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // Opalcoin: 1 day
        nTargetSpacing = 2.5 * 60; // Opalcoin: 2.5 minutes
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1474614187; 
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 32355075;
...
//        printf("merkle root=%s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x000005abfe70b570ec7fd409e39dca87cc154aae22773ae325c3fbae8b24d751"));
        ...
        //vSeeds.push_back(CDNSSeedData("opalcoinpay.io", "dnsseed.opalcoinpay.io"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of( 76);                    // Opalcoin addresses start with 'X'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 16);                    // Opalcoin script addresses start with '7'
        base58Prefixes[SECRET_KEY] =     list_of(204);                    // Opalcoin private keys start with '7' or 'X'
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x02)(0xFE)(0x52)(0xF8); // Opalcoin BIP32 pubkeys start with 'drkv'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0xFE)(0x52)(0xCC); // Opalcoin BIP32 prvkeys start with 'drkp'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000005);             // Opalcoin BIP44 coin type is '5'
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        /*vSeeds.push_back(CDNSSeedData("opalcoinpay.io", "testnet-seed.opalcoinpay.io"));
        vSeeds.push_back(CDNSSeedData("opalcoin.qa", "testnet-seed.opalcoin.qa"));
        *///legacy seeders
        vSeeds.push_back(CDNSSeedData("darkcoin.io",  "testnet-seed.darkcoin.io"));
        vSeeds.push_back(CDNSSeedData("darkcoin.qa", "testnet-seed.darkcoin.qa"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(139);                    // Testnet opalcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 19);                    // Testnet opalcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY]     = list_of(239);                    // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x3a)(0x80)(0x61)(0xa0); // Testnet opalcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x3a)(0x80)(0x58)(0x37); // Testnet opalcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000001);             // Testnet opalcoin BIP44 coin type is '5' (All coin's testnet default)
